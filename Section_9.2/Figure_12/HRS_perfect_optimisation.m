...
%T_sck Calculation
T_sc1 = square_abs(H(:,1)'*p_sc) + T_c1;
T_sc2 = square_abs(H(:,2)'*p_sc) + T_c2;
T_sc3 = square_abs(H(:,3)'*p_sc) + T_c3;
T_sc4 = square_abs(H(:,4)'*p_sc) + T_c4;
T_sc5 = square_abs(H(:,5)'*p_sc) + T_c5;
T_sc6 = square_abs(H(:,6)'*p_sc) + T_c6;
T_sc7 = square_abs(H(:,7)'*p_sc) + T_c7;
T_sc8 = square_abs(H(:,8)'*p_sc) + T_c8;
T_sc9 = square_abs(H(:,9)'*p_sc) + T_c9;
T_sc10 = square_abs(H(:,10)'*p_sc) + T_c10;
T_sc11 = square_abs(H(:,11)'*p_sc) + T_c11;
T_sc12 = square_abs(H(:,12)'*p_sc) + T_c12;
T_sc13 = square_abs(H(:,13)'*p_sc) + T_c13;
T_sc14 = square_abs(H(:,14)'*p_sc) + T_c14;
T_sc15 = square_abs(H(:,15)'*p_sc) + T_c15;
T_sc16 = square_abs(H(:,16)'*p_sc) + T_c16;
T_sc17 = square_abs(H(:,17)'*p_sc) + T_c17;
T_sc18 = square_abs(H(:,18)'*p_sc) + T_c18;
