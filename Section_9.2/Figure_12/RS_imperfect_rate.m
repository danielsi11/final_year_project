...
for i_sample = 1:S
    ...
    H_error_sample = H_error_sample([1 4 7 2 5 8 3 6 9],:);
    H_error_sample = H_error_sample(:,[1 2 7 8 13 14 3 4 9 10 15 16 5 6 11 12 17 18]);
...
while (loop)
    ...
    [rate, p_sc, p_1, p_2, p_3, p_4, p_5, p_6, p_7, p_8, p_9] = ...
    RS_imperfect_optimisation(H_est,PAC,t_k,t_sck,psi_k,psi_sck,f_k,f_sck,v_k,v_sck,u_k,u_sck);
