...
for i_channel = 1:N_channel
    ...
    for i_alpha = 1:length(alphas)+1
        ...
        for i_PAC = 1:length(PACs)
            ...
            H = H([1 4 7 2 5 8 3 6 9],:);
            H = H(:,[1 2 7 8 13 14 3 4 9 10 15 16 5 6 11 12 17 18]);

            H_est = H_est([1 4 7 2 5 8 3 6 9],:);
            H_est = H_est(:,[1 2 7 8 13 14 3 4 9 10 15 16 5 6 11 12 17 18]);
...
hold on
grid on
plot(PACs,MMF_NoRS_average(1,:,3),'-sm','Linewidth',1.2)
plot(PACs,MMF_RS_cluster_average(1,:,3),'-sg','Linewidth',1.2)
plot(PACs,MMF_HRS_average(1,:,3),'-sb','Linewidth',1.2)
...
legend('RS, perfect','NoRS, perfect','RS per cluster, perfect','HRS, perfect',...
'RS, imperfect 0.8','NoRS, imperfect 0.8','RS per cluster, imperfect 0.8','HRS, imperfect 0.8',...
