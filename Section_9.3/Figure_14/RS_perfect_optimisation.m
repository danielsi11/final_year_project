...
RS_perfect_optimisation(H,PAC,g_k,g_ck,W_k,W_ck)
...
variable p_c1(B,1) complex
variable p_c2(B,1) complex
variable p_c3(B,1) complex
variable C_1 
variable C_2 
variable C_3
variable C_4 
...
%Received Power
%T_k Calculation
T_1 = square_abs(H(:,1,2)'*p_c2) + square_abs(H(:,1,3)'*p_c3) + ...
square_abs(H(:,1,1)'*p_1) + square_abs(H(:,1,1)'*p_2) + square_abs(H(:,1,1)'*p_3) + ...
...
T_2 = square_abs(H(:,2,2)'*p_c2) + square_abs(H(:,2,3)'*p_c3) + ...
square_abs(H(:,2,1)'*p_1) + square_abs(H(:,2,1)'*p_2) + square_abs(H(:,2,1)'*p_3) + ...
...
T_3 = square_abs(H(:,3,2)'*p_c2) + square_abs(H(:,3,3)'*p_c3) + ...
square_abs(H(:,3,1)'*p_2) + square_abs(H(:,3,1)'*p_1) + square_abs(H(:,3,1)'*p_3) + ...
...
T_4 = square_abs(H(:,4,2)'*p_c2) + square_abs(H(:,4,3)'*p_c3) + ...
square_abs(H(:,4,1)'*p_2) + square_abs(H(:,4,1)'*p_1) + square_abs(H(:,4,1)'*p_3) + ...
...
T_5 = square_abs(H(:,5,2)'*p_c2) + square_abs(H(:,5,3)'*p_c3) + ...
square_abs(H(:,5,1)'*p_3) + square_abs(H(:,5,1)'*p_1) + square_abs(H(:,5,1)'*p_2) + ...
...
T_6 = square_abs(H(:,6,2)'*p_c2) + square_abs(H(:,6,3)'*p_c3) + ...
square_abs(H(:,6,1)'*p_3) + square_abs(H(:,6,1)'*p_1) + square_abs(H(:,6,1)'*p_2) + ...
...
T_7 = square_abs(H(:,7,1)'*p_c1) + square_abs(H(:,7,3)'*p_c3) + ...
square_abs(H(:,7,2)'*p_4) + square_abs(H(:,7,1)'*p_1) + square_abs(H(:,7,1)'*p_2) + ...
...
T_8 = square_abs(H(:,8,1)'*p_c1) + square_abs(H(:,8,3)'*p_c3) + ...
square_abs(H(:,8,2)'*p_4) + square_abs(H(:,8,1)'*p_1) + square_abs(H(:,8,1)'*p_2) + ...
...
T_9 = square_abs(H(:,9,1)'*p_c1) + square_abs(H(:,9,3)'*p_c3) + ...
square_abs(H(:,9,2)'*p_5) + square_abs(H(:,9,1)'*p_1) + square_abs(H(:,9,1)'*p_2) + ...
...
T_10 = square_abs(H(:,10,1)'*p_c1) + square_abs(H(:,10,3)'*p_c3) + ...
square_abs(H(:,10,2)'*p_5) + square_abs(H(:,10,1)'*p_1) + square_abs(H(:,10,1)'*p_2) + ...
...
T_11 = square_abs(H(:,11,1)'*p_c1) + square_abs(H(:,11,3)'*p_c3) + ...
square_abs(H(:,11,2)'*p_6) + square_abs(H(:,11,1)'*p_1) + square_abs(H(:,11,1)'*p_2) + ...
...
T_12 = square_abs(H(:,12,1)'*p_c1) + square_abs(H(:,12,3)'*p_c3) + ...
square_abs(H(:,12,2)'*p_6) + square_abs(H(:,12,1)'*p_1) + square_abs(H(:,12,1)'*p_2) + ...
...
T_13 = square_abs(H(:,13,1)'*p_c1) + square_abs(H(:,13,2)'*p_c2) + ...
square_abs(H(:,13,3)'*p_7) + square_abs(H(:,13,1)'*p_1) + square_abs(H(:,13,1)'*p_2) + ...
...
T_14 = square_abs(H(:,14,1)'*p_c1) + square_abs(H(:,14,2)'*p_c2) + ...
square_abs(H(:,14,3)'*p_7) + square_abs(H(:,14,1)'*p_1) + square_abs(H(:,14,1)'*p_2) + ...
...
T_15 = square_abs(H(:,15,1)'*p_c1) + square_abs(H(:,15,2)'*p_c2) + ...
square_abs(H(:,15,3)'*p_8) + square_abs(H(:,15,1)'*p_1) + square_abs(H(:,15,1)'*p_2) + ...
...
T_16 = square_abs(H(:,16,1)'*p_c1) + square_abs(H(:,16,2)'*p_c2) + ...
square_abs(H(:,16,3)'*p_8) + square_abs(H(:,16,1)'*p_1) + square_abs(H(:,16,1)'*p_2) + ...
...
T_17 = square_abs(H(:,17,1)'*p_c1) + square_abs(H(:,17,2)'*p_c2) + ...
square_abs(H(:,17,3)'*p_9) + square_abs(H(:,17,1)'*p_1) + square_abs(H(:,17,1)'*p_2) + ...
...
T_18 = square_abs(H(:,18,1)'*p_c1) + square_abs(H(:,18,2)'*p_c2) + ...
square_abs(H(:,18,3)'*p_9) + square_abs(H(:,18,1)'*p_1) + square_abs(H(:,18,1)'*p_2) + ...
...
%T_ck Calculation
T_c1 = square_abs(H(:,1,1)'*p_c1) + T_1;
T_c2 = square_abs(H(:,2,1)'*p_c1) + T_2;
T_c3 = square_abs(H(:,3,1)'*p_c1) + T_3;
T_c4 = square_abs(H(:,4,1)'*p_c1) + T_4;
T_c5 = square_abs(H(:,5,1)'*p_c1) + T_5;
T_c6 = square_abs(H(:,6,1)'*p_c1) + T_6;
T_c7 = square_abs(H(:,7,2)'*p_c2) + T_7;
T_c8 = square_abs(H(:,8,2)'*p_c2) + T_8;
T_c9 = square_abs(H(:,9,2)'*p_c2) + T_9;
T_c10 = square_abs(H(:,10,2)'*p_c2) + T_10;
T_c11 = square_abs(H(:,11,2)'*p_c2) + T_11;
T_c12 = square_abs(H(:,12,2)'*p_c2) + T_12;
T_c13 = square_abs(H(:,13,3)'*p_c3) + T_13;
T_c14 = square_abs(H(:,14,3)'*p_c3) + T_14;
T_c15 = square_abs(H(:,15,3)'*p_c3) + T_15;
T_c16 = square_abs(H(:,16,3)'*p_c3) + T_16;
T_c17 = square_abs(H(:,17,3)'*p_c3) + T_17;
T_c18 = square_abs(H(:,18,3)'*p_c3) + T_18;
...
%E_ck Calculation
E_c1 = abs(g_ck(1))^2*T_c1 - 2*real(g_ck(1)*H(:,1,1)'*p_c1) + 1;
E_c2 = abs(g_ck(2))^2*T_c2 - 2*real(g_ck(2)*H(:,2,1)'*p_c1) + 1;
E_c3 = abs(g_ck(3))^2*T_c3 - 2*real(g_ck(3)*H(:,3,1)'*p_c1) + 1;
E_c4 = abs(g_ck(4))^2*T_c4 - 2*real(g_ck(4)*H(:,4,1)'*p_c1) + 1;
E_c5 = abs(g_ck(5))^2*T_c5 - 2*real(g_ck(5)*H(:,5,1)'*p_c1) + 1;
E_c6 = abs(g_ck(6))^2*T_c6 - 2*real(g_ck(6)*H(:,6,1)'*p_c1) + 1;
E_c7 = abs(g_ck(7))^2*T_c7 - 2*real(g_ck(7)*H(:,7,2)'*p_c2) + 1;
E_c8 = abs(g_ck(8))^2*T_c8 - 2*real(g_ck(8)*H(:,8,2)'*p_c2) + 1;
E_c9 = abs(g_ck(9))^2*T_c9 - 2*real(g_ck(9)*H(:,9,2)'*p_c2) + 1;
E_c10 = abs(g_ck(10))^2*T_c10 - 2*real(g_ck(10)*H(:,10,2)'*p_c2) + 1;
E_c11 = abs(g_ck(11))^2*T_c11 - 2*real(g_ck(11)*H(:,11,2)'*p_c2) + 1;
E_c12 = abs(g_ck(12))^2*T_c12 - 2*real(g_ck(12)*H(:,12,2)'*p_c2) + 1;
E_c13 = abs(g_ck(13))^2*T_c13 - 2*real(g_ck(13)*H(:,13,3)'*p_c3) + 1;
E_c14 = abs(g_ck(14))^2*T_c14 - 2*real(g_ck(14)*H(:,14,3)'*p_c3) + 1;
E_c15 = abs(g_ck(15))^2*T_c15 - 2*real(g_ck(15)*H(:,15,3)'*p_c3) + 1;
E_c16 = abs(g_ck(16))^2*T_c16 - 2*real(g_ck(16)*H(:,16,3)'*p_c3) + 1;
E_c17 = abs(g_ck(17))^2*T_c17 - 2*real(g_ck(17)*H(:,17,3)'*p_c3) + 1;
E_c18 = abs(g_ck(18))^2*T_c18 - 2*real(g_ck(18)*H(:,18,3)'*p_c3) + 1;
...
constraints(53) = C_8;
constraints(54) = C_9;
constraints(55) = PAC - (p_c1'*D1*p_c1 + p_1'*D1*p_1 + p_2'*D1*p_2 + p_3'*D1*p_3);
constraints(56) = PAC - (p_c1'*D2*p_c1 + p_1'*D2*p_1 + p_2'*D2*p_2 + p_3'*D2*p_3);
constraints(57) = PAC - (p_c1'*D3*p_c1 + p_1'*D3*p_1 + p_2'*D3*p_2 + p_3'*D3*p_3);
constraints(58) = PAC - (p_c2'*D1*p_c2 + p_4'*D1*p_4 + p_5'*D1*p_5 + p_6'*D1*p_6);
constraints(59) = PAC - (p_c2'*D2*p_c2 + p_4'*D2*p_4 + p_5'*D2*p_5 + p_6'*D2*p_6);
constraints(60) = PAC - (p_c2'*D3*p_c2 + p_4'*D3*p_4 + p_5'*D3*p_5 + p_6'*D3*p_6);
constraints(61) = PAC - (p_c3'*D1*p_c3 + p_7'*D1*p_7 + p_8'*D1*p_8 + p_9'*D1*p_9);
constraints(62) = PAC - (p_c3'*D2*p_c3 + p_7'*D2*p_7 + p_8'*D2*p_8 + p_9'*D2*p_9);
constraints(63) = PAC - (p_c3'*D3*p_c3 + p_7'*D3*p_7 + p_8'*D3*p_8 + p_9'*D3*p_9);
